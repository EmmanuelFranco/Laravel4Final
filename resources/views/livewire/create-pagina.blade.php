<div>
    ...
    <x-button type="button" wire:click="$set('open',true)">Crear pagina</x-button>
    ...
    <x-dialog-modal wire:model="open">
        ...
        <x-slot name="content">
            <div>
                ...
                <input type="text" wire:model='nombre_pagina'
            ...
            <div>
                <label for="large-input" class="block mb-2 text-sm font-medium ">Descripcion</label>
                <input type="text" wire:model='descripcion_pagina'
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 "
                      />
            </div>
            <div>
                <label for="large-input" class="block mb-2 text-sm font-medium ">Url</label>
                <input type="text" wire:model='url_pagina'
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 "
                    required />
            </div>
